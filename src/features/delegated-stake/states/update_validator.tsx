...
export type IDelegatedStake_ChangeValidator_MachineContext = {
  ...
  network: HgtpNetwork;
  prevDelegator: IAPIStakingDelegator | null;
...
export type IDelegatedStake_ChangeValidator_Machine = IStateMachine<
  IDelegatedStake_ChangeValidator_MachineContext,
  "initial" | "review" | "delegating" | "delegated",
  "error" | "reset" | "select" | "delegate" | "confirmedDelegation"
>;

export const createDelegatedStake_ChangeValidator_Machine = (
  context: IDelegatedStake_ChangeValidator_MachineContext
) => {
  return createStateMachineStore<IDelegatedStake_ChangeValidator_Machine>(
    {
      initial: {
        events: {
          select: {
